...
/*
 ...
 Template Name: Phong Thuy - Mua nhà Teamplate
                    ...
                    <div class="direction">
                        ...
                        <div class="content-direction">
                            <div class="icon-direction">
                                <img src="<?php bloginfo('template_url'); ?>/phongthuy/xem-mua-nha-02.png">
                            </div>
                            <div class="info-see">
                    ...
                    <div class="default">
                        ...
                        <div class="result">
                            ...
                            <div class="directions">
                                <p class="title-info">
                                    TUỔI <span class="par-age"></span> MUA NHÀ NĂM <span class="down-line"></span> <span class="year_buy_build"></span> - <span class="par-age-year"></span>
                                </p>
                                    ...
                                    <div class="content-par ">
                                        <div class="info-direction content-par-buy-house">
                                            <div class="type-direction">
                                                <div class="item">
                                                    <p class="title-supply">HƯỚNG TỐT</p>
                                                    <div class="direction-supply">
                                                        <div class="supply-item">
                                                            <span class="txt-cricle"></span>
                                                            <p>Cửu Trạch</p>
                                                            <p>Năm <span class="year_buy_build"></span>, bạn <span class="old"></span> <span class="kind">sẽ thuộc Hư trong Cửu Trạch.</span> </p>
                                                        </div>
                                                        <div class="supply-item">
                                                            <span class="txt-cricle"></span>
                                                            <p>Tam Tai</p>
                                                            <p>Tuổi <span class="par-age"></span> cần tránh các năm Tam Tai: <span class="three-ears"></span>. Năm dự kiến mua nhà là năm <span class="year_buy_build"></span> tức năm <span class="par-age-year"></span>, <span class="txt-result"></span> </p>
                                                        </div>
                                                        <div class="supply-item">
                                                            <span class="txt-cricle"></span>
                                                            <p>Kim Lâu</p>
                                                            <p>Năm <span class="year_buy_build"></span>, bạn <span class="old"></span>  nếu năm đó tiến hành mua nhà sẽ <span class="text-brown"></span> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="item">
                            ...
                            <div class="more-feng-shui">
                                <div class="more-content">
                                    ...
                                    <div class="see-feng-shui">
                                        <span class="txt-cricle"></span>
                                        <a href="<?php bloginfo('home')?>/xem-tuoi-xay-nha" title="Xem tuổi xây nhà">Xem tuổi xây nhà</a>
                                    </div>
                                    <div class="see-feng-shui">
                                        <span class="txt-cricle"></span>
