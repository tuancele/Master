<div class="box-interest-rate">
            ...
            <div class="h2">TÍNH LÃI SUẤT VAY <svg viewBox="0 0 24 24"><polyline fill="none" points="21,8.5 12,17.5 3,8.5 " stroke="#0a0a0a" stroke-miterlimit="10" stroke-width="2"/></svg></div>

            <div>

                

                <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/css/rangeslider-custom.css">
                ...
                <div class="interest-rates">
                    ...
                    <div class="calculator-result">
                        ...
                        <div class="more-result">
                            ...
                            <a href="<?php bloginfo('home')?>/tinh-lai-suat-vay/" onclick="to_detail()" target="_blank">Xem lịch trả nợ từng tháng <span class="fa fa-arrow-right"></span> </a>
