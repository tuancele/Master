...
//	stt++;
	...
	ctx.fillText("Lấy lá số tại https://tuvisonghung.com.vn/", width/2, 3*height/4 - 16);
	ctx.textAlign="left";	
	ctx.fillStyle = "#000000";
	ctx.stroke();
}
...
//	stt++;
	...
	ctx.fillText("Lấy lá số tại https://tuvisonghung.com.vn/", width/2, 3*height/4 - 32);
