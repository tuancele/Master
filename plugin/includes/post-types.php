...
/**
 * Post Type: Lead (Khách hàng tiềm năng)
 * Dùng để lưu trữ dữ liệu form cho xử lý bất đồng bộ.
 */
function nhadat86_register_lead_cpt() {
    $labels_lead = array(
        'name'                => __( 'Leads', 'text-domain' ),
        'singular_name'       => __( 'Lead', 'text-domain' ),
        'menu_name'           => __( 'Leads', 'text-domain' ),
        'all_items'           => __( 'All Leads', 'text-domain' ),
        'add_new'             => __( 'Add New', 'text-domain' ),
        'add_new_item'        => __( 'Add New Lead', 'text-domain' ),
        'edit_item'           => __( 'Edit Lead', 'text-domain' ),
        'new_item'            => __( 'New Lead', 'text-domain' ),
        'view_item'           => __( 'View Lead', 'text-domain' ),
        'search_items'        => __( 'Search Leads', 'text-domain' ),
        'not_found'           => __( 'No Leads found', 'text-domain' ),
        'not_found_in_trash'  => __( 'No Leads found in Trash', 'text-domain' ),
    );
    $args_lead = array(
        'labels'              => $labels_lead,
        'public'              => false,  // Không public ra ngoài
        'publicly_queryable'  => false,
        'show_ui'             => true,   // Hiển thị trong admin
        'show_in_menu'        => true,   // Hiển thị menu
        'query_var'           => false,
        'rewrite'             => false,
        'capability_type'     => 'post',
        'has_archive'         => false,
        ...
        'supports'            => array( 'title', 'custom-fields' ), // Chỉ cần Tiêu đề và Custom Fields
        'show_in_rest'        => false,
    );
    register_post_type( 'lead', $args_lead );
}
add_action( 'init', 'nhadat86_register_lead_cpt' );
