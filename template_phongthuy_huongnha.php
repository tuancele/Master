...
/*
 ...
 Template Name: Phong Thuy - Hướng Nhà Teamplate
                    ...
                    <div class="direction">
                        ...
                        <div class="content-direction">
                            <div class="icon-direction">
                                <img src="<?php bloginfo('template_url'); ?>/phongthuy/xem-huong-nha-02.png">
                            </div>
                            <div class="info-see">
                    ...
                    <div class="default">
                        ...
                        <div class="result">
                            ...
                            <div class="directions">
                                <p class="title-info">
                                    CÁC HƯỚNG TỐT VÀ HƯỚNG XẤU CỦA BẠN - MỆNH <span class="my-par">KHÔN</span>
                                </p>
                                    ...
                                    <div class="content-par">
                                        <div class="info-direction">
                                            <div class="type-direction">
                                                <div class="item">
                                                    ...
                                                    <div class="direction-supply direction-good ">
                                                    </div>
                                                </div>
                                                <div class="item">
                                                    <p class="title-supply">HƯỚNG XẤU</p>
                                                    <div class="direction-supply direction-bad">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="compass">
                                            <div class="compass-content">
                                                <img src="<?php bloginfo('template_url'); ?>/phongthuy/bat-quai/kham.png" class="bagua">
                                                <div class="note-fengshui">
                                                    <p>Lưu ý: Bấm vào hình để xoay.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
